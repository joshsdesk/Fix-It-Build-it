            ...
            {isOpen && (
                <div className="fixed inset-0 z-[110] flex items-center justify-center px-6">
                    ...
                    >
                        <button
                            onClick={onClose}
                            className="absolute top-6 right-6 btn-action-close"
                        >
                            <X className="w-6 h-6" />
                        </button>
                        ...
                        <div className="space-y-8 relative">
                            ...
                            {steps.map((step, index) => (
                                ...
                                >
                                    <div className="group w-14 h-14 rounded-full bg-slate-900 border border-fibi-accent/30 hover:border-fibi-purple/50 transition-colors flex items-center justify-center shrink-0 z-10 shadow-lg shadow-fibi-accent/10 cursor-pointer">
                                        <step.icon className="w-6 h-6 text-fibi-accent group-hover:text-fibi-purple transition-colors" />
                                    </div>
                                    <div>
