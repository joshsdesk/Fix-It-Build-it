...
export default function Services() {
    return (
        <section id="services" className="relative h-full min-h-0 flex flex-col justify-start lg:justify-center py-20 sm:py-20 lg:py-12 pb-20 sm:pb-24 lg:pb-12 bg-gradient-to-b from-background to-stone-900 overflow-hidden scroll-mt-16 sm:scroll-mt-20 lg:scroll-mt-24">
            <div className="layout-container relative z-10">
                <div className="flex flex-col gap-5 lg:gap-4">
                    ...
                    <div className="flex flex-col gap-6 lg:gap-5 w-full relative">
